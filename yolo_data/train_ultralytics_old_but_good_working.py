...
def main():
    ...
    model.train(
        ...
        name="run_v1",
        # Augmentations agressives pour éviter l'overfitting
        ...
        flipud=0.0,        # JAMAIS de miroir vertical pour le badminton (le haut et le bas sont différents en perspective)
        save=True
    )
